...
export function registerAuthoringGuideTool(server: McpServer) {
  server.tool(
    ...
    "Read this BEFORE building a structured learning course, subject or lessons. The full method for producing a structured learning course " +
      ...
      "ground every claim in a real source. Do not use it for a flashcard deck collection. Read-only; takes no arguments.",
    {},
    async () =>
