...
export function registerAuthoringGuideTool(server: McpServer) {
  server.tool(
    ...
    "Read this BEFORE building a course, subject or lessons. The full method for producing a structured course " +
      ...
      "ground every claim in a real source. Read-only; takes no arguments.",
    {},
    async () =>
